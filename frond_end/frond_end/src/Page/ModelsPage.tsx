...
function ModelsPage() {
        ...
        if (res.table) {
          res.table.forEach((item: any) => {
            if (item.progress === "100%") {
              completed.push(Number(item.topic.replace("Level ", "")))
            }
          })
        }
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-500 relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="mb-10 text-center">
          ...
          <div className="flex justify-center gap-6 mt-6">
            {[
              { icon: Flame, label: "Levels", value: "9", color: "text-orange-500" },
              { icon: BarChart2, label: "Completed", value: String(completedLevels.length), color: "text-green-500" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {levels.map((level, idx) => {
            ...
            return (
              <div
                key={level.id}
                className="group relative rounded-2xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:-translate-y-1"
                style={{
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xl font-black text-black dark:text-white">{level.title}</span>
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider border border-gray-300 dark:border-zinc-700 px-1.5 py-0.5 rounded">
                          {level.subtitle}
                        </span>
                      </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex justify-between mt-1 text-[10px] text-gray-400">
                      <span>{isCompleted ? "100%" : "0%"} progress</span>
